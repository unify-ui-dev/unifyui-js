import { appendBefore, findAll } from "@unifyui-js/dom_util"
...
class Offcanvas {
   ...
   */
    ...
    /**
   * Find Offcanvas elements based on the provided selector and Offcanvas ID.
   */
    ...
    /**
   * Setup required attributes for the Offcanvas element.
   */
